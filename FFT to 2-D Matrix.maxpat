{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 59.0, 1253.0, 679.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 59.0, 1253.0, 679.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 451.0, 363.0, 32.5, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 462.0, 330.0, 44.0, 20.0 ],
					"id" : "obj-36",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 363.0, 341.0, 18.0, 20.0 ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 341.0, 18.0, 20.0 ],
					"id" : "obj-38",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 264.0, 385.0, 34.0, 20.0 ],
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 352.0, 385.0, 34.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 352.0, 363.0, 32.5, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 33.0, 341.0, 35.0, 20.0 ],
					"id" : "obj-19",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 297.0, 50.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 319.0, 44.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 64.5, 350.5, 207.5, 350.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 64.5, 350.5, 328.5, 350.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 64.5, 361.5, 449.5, 361.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 64.5, 350.5, 449.5, 350.5 ]
				}
